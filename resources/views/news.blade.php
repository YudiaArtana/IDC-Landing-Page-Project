    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="mb-4 mt-4">
                ...
                <div class="position-relative">
                    <button type="button" class="btn btn-outline-warning lh-base float-end" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                        Selengkapnya <i class="bi bi-arrow-right align-middle ps-2 icon-proker"></i>
                    </button>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="trending mt-4">
                ...
                <div class="position-relative">
                    <button type="button" class="btn btn-outline-warning lh-base float-end" data-aos="fade-left" data-aos-delay="50" data-aos-duration="1000">
                        Selengkapnya <i class="bi bi-arrow-right align-middle ps-2 icon-proker"></i>
                    </button>
                </div>
            </div>
