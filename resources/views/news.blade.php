                    ...
                    <div class="row">
                        <div class="headline-data-science col-12 mb-3 pe-0">
                            <div class="card-news-2">
                                ...
                                <h4 class="box-text-category-2 p-5 pt-0">Extracting Valuable Insights from Big Data</h4>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="headline-blockchain col-6 pe-0">
                            <div class="card-news-3">
                                ...
                                <h5 class="box-text-category-3 p-5 pt-0">Innovative Data Security Paradigm</h5>
                            </div>
                        </div>
                        <div class="headline-IoT col-6 pe-0">
                            <div class="card-news-4">
                                ...
                                <h5 class="box-text-category-5 p-5 pt-0">New Challenges in the Connected Era</h5>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="main-hero-news-1">
    <div class="container hero-news">
        <section id="slider">
            <div class="container">
                <h1 class="text-center position-relative mb-4" data-aos="zoom-in-up" data-aos-delay="50" data-aos-duration="1000"><b class="underline-1">NEWS HIGHLIGHT</b></h1>
                <div class="slider" data-aos="zoom-in" data-aos-delay="50" data-aos-duration="1000">
                    <div class="owl-carousel">
                        ...
                        <div class="slider-card">
                            ...
                            <h5 class="mb-0 text-center"><b class="title-slider-card">TechConnect Sandbox 2023 Webinar</b></h5>
                            <p class="text-slider-card text-center p-0 opacity-50">Fri, 28 April 2023</p>
                            <p class="text-slider-card text-center p-4 pt-0">Don't miss the opportunity to showcase your potential at TechConnect Sandbox 2023!</p>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="img/news/Seminar-1.webp" alt="">
                            </div>
                            <h5 class="mb-0 text-center"><b class="title-slider-card">National Seminar</b></h5>
                            <p class="text-slider-card text-center p-0 opacity-50">Sat, 04 February 2023</p>
                            <p class="text-slider-card text-center p-4 pt-0">Are you ready to become a Website Developer? We are from INSTIKI Developer Club, INSTIKI Student Activity Unit.</p>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                                <img src="img/news/pengabdian-kepada-masyarakat.webp" alt="">
                            </div>
                            <h5 class="mb-0 text-center"><b class="title-slider-card">Community Service</b></h5>
                            <p class="text-slider-card text-center p-0 opacity-50">Tue, 11 July 2023</p>
                            <p class="text-slider-card text-center p-4 pt-0">The INSTIKI Developer Club community moved to the Tat Twam Asi foundation, an orphanage located on Jl. Jaya Giri IX no. 6 Denpasar.</p>
                        </div>
                        <div class="slider-card">
                            <div class="d-flex justify-content-center align-items-center mb-4">
                            ...
                            <p class="text-slider-card text-center p-0 opacity-50">Wed, 08 February 2023</p>
        ...
        <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
            <div class="mb-4 mt-4">
                <div class="section-title-news">
                    <h1 class="mb-4" data-aos="fade-right" data-aos-delay="50" data-aos-duration="1000"><b class="underline-3">Latest</b></h1>
                </div>
                ...
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <p class="summary pt-3">Happy Eid al-Fitr 2023. May we all be happy and peaceful on this festive day.</p>
                    </div>
                </div>
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <small>21 April, 2023</small>
                        <p class="summary pt-3">The challenges in life come and go, but believe that 'After Darkness Comes Light.' Happy Kartini Day.</p>
                    </div>
                </div>
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <p class="summary pt-3">All Members of the Instiki Developer Club (IDC) would like to say, Happy Good Friday, praying that the Lord embraces you in His love and blesses you with His grace on this Holy Day.</p>
                    </div>
                </div>
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                ...
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <p class="summary pt-3">We, the members of IDC (Instiki Developer Club), would like to extend our congratulations on celebrating the Holy Month of Victory. May you always be able to perform your worship smoothly and without hindrance.</p>
                    </div>
                </div>
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <p class="summary pt-3">Hello INSTIKI Devs👋 Let's take a look at the precious moments from the INSTIKI Developer Club National Seminar with the theme 'Develop Skills for Becoming a Web Developer'! This event successfully helped participants broaden their horizons and enhance their skills in the field of web development. Thank you to all the speakers and participants who joined this seminar.</p>
                    </div>
                </div>
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                ...
                <div class="terbaru-content row mb-3" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                    ...
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <small>04 February, 2023</small>
                        <p class="summary pt-3">"With direct mentoring by Prabu Rangki, a Software Engineer at Kintell from the Google Developer Group. So, what are you waiting for, guys? Come and join us, and enjoy our event! 🔥🔥 Get your new experience 🔥🔥 With training from extraordinary speakers, you can get it at an affordable price!".</p>
                    </div>
                </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
            <div class="trending mt-4">
                <div class="section-title-news"  data-aos="fade-left" data-aos-delay="50" data-aos-duration="1000">
                    <h1 class="mb-4"><b class="underline-4">Popular</b></h1>
                </div>
